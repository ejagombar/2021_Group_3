...
float ModelRender:: getX(){return X;}
float ModelRender:: getY(){return Y;}
float ModelRender:: getZ(){return Z;}
float ModelRender:: getRX(){return RX;}
float ModelRender:: getRY(){return RY;}
float ModelRender:: getRZ(){return RZ;}
