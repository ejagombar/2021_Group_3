...
{
   vtkFilter->reflect(ModelList.at(row),renderer);
   renderWindow->Render();
...
{
   vtkFilter->outLine(ModelList.at(row),renderer,x,y,z);
   renderWindow->Render();
...
{
    vtkFilter->smooth(ModelList.at(row),renderer);
    renderWindow->Render();
...
{
    vtkFilter->smoothadd(ModelList.at(row),renderer);
    renderWindow->Render();
...
{
    vtkFilter->shrinkFilter(ModelList.at(row),renderer);
    renderWindow->Render();
...
{
    vtkFilter->clipFilter(ModelList.at(row),renderer);
    renderWindow->Render();
...
{
    vtkFilter->RemoveFilter(ModelList.at(row),renderer);
    renderWindow->Render();
...
void MainWindow::readSTL()
{
    ...
    ModelNew->RenderingStarts(renderer);
    ModelList.push_back(ModelNew);
...
{
    double area = vtkFilter->calcA(ModelList.at(row));
    QMessageBox msgBox;
...
{
    double vol = vtkFilter->calcV(ModelList.at(row));
    QMessageBox msgBox;
...
{
    x = ui->changeX->value();
    ModelList.at(row)->changeX(x,renderer);
    renderWindow->Render();
...
{
    y = ui->changeY->value();
    ModelList.at(row)->changeY(y,renderer);
    renderWindow->Render();
...
{
    z = ui->changeZ->value();
    ModelList.at(row)->changeZ(z,renderer);
    renderWindow->Render();
...
void MainWindow::changeRX()
{
    float x;
    x = ui->RX->value()/60;
    ModelList.at(row)->changeRX(x,renderer);
    renderWindow->Render();
...
void MainWindow::changeRY()
{
    float y;
    y = ui->RY->value()/60;
    ModelList.at(row)->changeRY(y,renderer);
    renderWindow->Render();
...
void MainWindow::changeRZ()
{
    float z;
    z = ui->RZ->value()/60;
    ModelList.at(row)->changeRZ(z,renderer);
    renderWindow->Render();
...
void MainWindow::on_list_itemSelectionChanged()
{
    ...
    //ModelList.at(row)->setActorColor();
    renderWindow->Render();
    ui->changeX->setValue(ModelList.at(row)->getX());
    ui->changeY->setValue(ModelList.at(row)->getY());
    ui->changeZ->setValue(ModelList.at(row)->getZ());

    ui->RX->setValue(ModelList.at(row)->getRX());
    ui->RY->setValue(ModelList.at(row)->getRY());
    ui->RZ->setValue(ModelList.at(row)->getRZ());
